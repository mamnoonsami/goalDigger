...
export async function getUsers() {
    ...
    const { data, error } = await supabase
        .from('profiles')
        .select('id, first_name, last_name, nickname, avatar_url, role, is_admin, is_king, is_manager, is_player, is_viewer, player_position, base_score, goals, matches_played, auction_budget, created_at, updated_at')
